...
class BaseDatos(context: Context,
    ...
    override fun onCreate(p0: SQLiteDatabase?) {
        ...
        p0?.execSQL("CREATE TABLE DETALLECOMPRA(IDDETALLE INTEGER PRIMARY KEY AUTOINCREMENT, CANTIDAD INTEGER, PRECIO VARCHAR(30), IDALMACEN INTEGER, FOREIGN KEY (IDALMACEN) REFERENCES ALMACEN(IDALMACEN))")
